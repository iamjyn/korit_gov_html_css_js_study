...
// promise 객체는 "state"와 "result" 속성을 가지고 있다.
...
// primise의 인자로 함수를 전달 => executor를 전달
// 객체 생성과 동시에 즉시 실행
// resolve => 비동기 작업이 성공했을 때, 호출하는 함수(executor의 콜백함수)
// reject => 비동기 작업이 실패했을 때, 호출하는 함수(executor의 콜백함수)
